...
/*
*   This section covers how to decode received data for Ellenex Dissolved Oxygen Sensor (CDO2-L)
*/
const decodeCDO2 = function() {
    ...
    console.log("Dissolved Oxygen: " + decodedData.sensorReading)
